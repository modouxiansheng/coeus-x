...
public class PassthroughDataflowMethodVisitor extends TaintTrackingMethodVisitor<Integer>{
    ...
    public PassthroughDataflowMethodVisitor(int i, int access, String desc, String owner, String name, MethodVisitor mv, Map<CoeusMethodNode,Set<Integer>> passthroughDataflow
...
//                new MethodReference.Handle(new ClassReference.Handle(owner), name, desc);
                if (classRouter.getClass(owner)!= null){
